            ...
            <div class="admin-modal" style="max-width: 500px;">
                <div class="admin-modal-header">
                    <h2 style="margin: 0; font-size: 1.5rem; font-weight: 700;">
                        ⚠️ ${lang === 'uz' ? 'Parolni tiklash' : 'Сброс пароля'}
                    </h2>
                ...
                <div class="admin-modal-body">
                    ${studentName ? `
                        <div style="padding: 1rem; background: var(--bg-secondary); border-radius: 8px; margin-bottom: 1.5rem; border-left: 4px solid #667eea;">
                            ...
                            ${studentEmail ? `<div style="font-size: 0.85rem; color: var(--text-secondary); margin-top: 0.5rem;">📧 ${studentEmail}</div>` : ''}
                        </div>
                    ` : ''}
                    <div style="padding: 1rem; background: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 8px; margin-bottom: 1.5rem;">
                        <div style="color: #92400e; font-size: 0.95rem; line-height: 1.5;">
                            ${lang === 'uz' ?
            '✓ Sistem avtomatik xavfsiz parol yaratadi<br>✓ Parol emailga yuboriladi<br>✓ O\'quvchi yangi parol bilan kirganda, yangi parol o\'rnatishi kerak bo\'ladi' :
            '✓ Система автоматически создаст безопасный пароль<br>✓ Пароль будет отправлен на email<br>✓ При входе с новым паролем ученик должен будет установить свой пароль'
        }
                        </div>
                    </div>
                    <div style="display: flex; gap: 1rem; justify-content: flex-end;">
                        ...
                        <button onclick="window.confirmResetStudentPassword('${studentId}')" class="btn btn-primary" style="background: #f59e0b; border-color: #f59e0b;">
                            ${lang === 'uz' ? 'Parolni tiklash' : 'Сбросить пароль'}
                        </button>
                    </div>
                </div>
